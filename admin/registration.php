...
<div class="col-sm-8">
<input type="text" name="contact" id="contact"  class="form-control" maxlength="10" pattern="[0-9]{10}" required="required" >
</div>
</div>
...
<div class="col-sm-8">
<input type="text" name="econtact" id="econtact"  class="form-control" maxlength="10" pattern="[0-9]{10}" required="required">
</div>
</div>
...
<div class="col-sm-8">
<input type="text" name="gcontact" id="gcontact"  class="form-control" maxlength="10" pattern="[0-9]{10}" >
</div>
</div>	
