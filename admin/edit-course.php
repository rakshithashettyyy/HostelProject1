	 ...
	 //$cnt=1;
	   while($row=$res->fetch_object())
	  {
	  	?>
						...
						<label class="col-sm-2 control-label">Course Code  <span style="color:red;">*</label>
					<div class="col-sm-8">
...
<div class="form-group">
									<label class="col-sm-2 control-label">Course Name(Full) <span style="color:red;">*</label>
									<div class="col-sm-8">
