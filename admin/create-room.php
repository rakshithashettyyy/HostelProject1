...
<?php } ?>
										<form method="post" class="form-horizontal">
											...
											<div class="form-group">
												<label class="col-sm-2 control-label">Select Seater  <span style="color:red;">* </label>
												<div class="col-sm-8">
...
<div class="form-group">
<label class="col-sm-2 control-label">Fee(Per Student) <span style="color:red;">*</label>
<div class="col-sm-8">
