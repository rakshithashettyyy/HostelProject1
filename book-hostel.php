...
<div class="form-group">
<label class="col-sm-2 control-label">Room no.<span style="color:red;">* </label>
<div class="col-sm-8">
...
<div class="form-group">
<label class="col-sm-2 control-label">Duration <span style="color:red;">*</label>
<div class="col-sm-8">
...
<div class="form-group">
<label class="col-sm-2 control-label">course <span style="color:red;">*</label>
<div class="col-sm-8">
...
<div class="form-group">
<label class="col-sm-2 control-label">Registration No: </span></label>
<div class="col-sm-8">
<input type="text" name="regno" id="regno"  class="form-control" value="<?php echo $row->regNo;?>" readonly required>
</div>
</div>


<div class="form-group">
<label class="col-sm-2 control-label">First Name :  <span style="color:red;">*</label>
<div class="col-sm-8">
<input type="text" name="fname" id="fname"  class="form-control" value="<?php echo $row->firstName;?>" required>
</div>
</div>
...
<div class="form-group">
<label class="col-sm-2 control-label">Last Name :  <span style="color:red;">*</label>
<div class="col-sm-8">
...
<div class="form-group">
<label class="col-sm-2 control-label">Contact No : <span style="color:red;">* </label>
<div class="col-sm-8">
<input type="text" name="contact" id="contact" maxlength="10"  value="<?php echo $row->contactNo;?>"  class="form-control" required>
</div>
</div>
...
<?php } ?>
<div class="form-group">
<label class="col-sm-2 control-label">Emergency Contact:  <span style="color:red;">*</label>
<div class="col-sm-8">
<input type="text" name="econtact" id="econtact" maxlength="10"  class="form-control" required="required">
</div>
</div>
...
<div class="form-group">
<label class="col-sm-2 control-label">Address : <span style="color:red;">* </label>
<div class="col-sm-8">
...
<div class="form-group">
<label class="col-sm-2 control-label">City : <span style="color:red;">* </label>
<div class="col-sm-8">
...
<div class="form-group">
<label class="col-sm-2 control-label">State  <span style="color:red;">*</label>
<div class="col-sm-8">
...
<div class="form-group">
<label class="col-sm-2 control-label">Pincode : <span style="color:red;">* </label>
<div class="col-sm-8">
